...
; path condition under which dumped expression is valid (use in ITE)
(define-fun |path_cond_2| () Bool (=  false (bvslt  (_ bv99 32) (concat  (select  pos (_ bv3 32) ) (concat  (select  pos (_ bv2 32) ) (concat  (select  pos (_ bv1 32) ) (select  pos (_ bv0 32) ) ) ) ) ) ))
